...
export const ProductPDP: React.FC<ProductPDPProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-white/85 dark:bg-black/85 backdrop-blur-md z-40 flex items-center justify-center p-4 overflow-y-auto">
      {/* Container */}
      <motion.div
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-6 right-6 p-2 rounded-full bg-white/40 dark:bg-black/40 hover:bg-white/60 dark:bg-black/60 text-neutral-600 dark:text-neutral-400 hover:text-gold transition-colors z-50 border border-black/10 dark:border-white/10 hover:border-gold/30"
        >
          <X size={18} />
        </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12">
          ...
          <div className="lg:col-span-6 bg-white/65 dark:bg-black/65 p-6 sm:p-8 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-black/5 dark:border-white/5 min-h-[400px] sm:min-h-[500px]">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center gap-1.5 mt-0.5">
                  ...
                  <span className="text-[10px] font-sans font-medium text-neutral-600 dark:text-neutral-400 tracking-wider">
                ...
                <button
                  ...
                  className={`text-[9px] font-mono uppercase tracking-wider px-2.5 py-1 rounded-full border transition-all ${
                    showCustomized
                      ...
                      : "bg-transparent text-neutral-600 dark:text-neutral-400 border-black/5 dark:border-white/5 hover:text-black dark:text-white hover:border-black/20 dark:border-white/20"
                  }`}
            ...
            <div className="flex-1 flex items-center justify-center py-4 relative">
              ...
              <div className="absolute inset-0 pointer-events-none flex items-center justify-center opacity-5">
                <div className="w-64 h-64 rounded-full border border-dashed border-black dark:border-white" />
                <div className="w-80 h-80 rounded-full border border-dashed border-black dark:border-white absolute" />
            ...
            <div className="space-y-4">
              ...
              {product.isKit && (
                <div className="bg-neutral-100/40 dark:bg-neutral-900/40 p-3 rounded-2xl border border-neutral-100 dark:border-neutral-900 flex items-center justify-between">
                  <div className="space-y-0.5">
                    <span className="text-[10px] font-mono uppercase tracking-wider text-neutral-600 dark:text-neutral-400 flex items-center gap-1">
                      <Box size={11} className="text-neutral-600 dark:text-neutral-400" /> Vista Explodida do Kit
                    </span>
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg text-[9px] font-mono uppercase tracking-wider transition-all border ${
                      isExploded
                        ? "bg-white text-black border-black dark:border-white font-semibold"
                        : "bg-transparent text-neutral-600 dark:text-neutral-400 border-neutral-200 dark:border-neutral-800 hover:text-black dark:text-white hover:border-neutral-700"
                    }`}
                  >
                      ...
                      <button
                        ...
                        className={`text-[9px] font-mono py-2 px-3 rounded-lg border transition-all ${
                          activePerspective === persp.id
                            ? "bg-white/10 text-black dark:text-white border-neutral-600"
                            : "bg-transparent text-neutral-600 dark:text-neutral-400 border-neutral-100 dark:border-neutral-900 hover:text-black dark:text-white hover:border-neutral-700"
                        }`}
                      >
                        {persp.name}
                      </button>
          ...
          <div className="lg:col-span-6 p-6 sm:p-8 flex flex-col justify-between space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <span className="text-[9px] font-mono bg-white dark:bg-black text-gold/80 px-2 py-0.5 rounded border border-black/5 dark:border-white/5 uppercase tracking-wider font-semibold">
                  {product.category}
                </span>
              ...
              <h1 className="text-2xl font-sans font-semibold text-black dark:text-white tracking-tight leading-tight">
                {product.name}
              </h1>
            ...
            <div className="grid grid-cols-2 gap-4 p-4 bg-white/45 dark:bg-black/45 rounded-2xl border border-black/5 dark:border-white/5 font-mono text-[10px]">
              <div className="space-y-0.5">
              ...
              <div className="space-y-0.5 pt-2 border-t border-black/5 dark:border-white/5">
            ...
            <div className="space-y-4">
              <h3 className="text-xs font-mono uppercase tracking-widest text-gold border-b border-black/5 dark:border-white/5 pb-2 flex items-center gap-1">
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] uppercase font-mono tracking-wider text-neutral-500 flex justify-between">
                  ...
                  <span className="text-[9px] text-neutral-600 dark:text-neutral-400">Atualiza no mockup</span>
                </label>
                <input
                  type="text"
                  maxLength={20}
                  ...
                  className="w-full bg-neutral-100/60 dark:bg-neutral-900/60 border border-neutral-200 dark:border-neutral-800 focus:border-gold focus:ring-1 focus:ring-gold/35 focus:outline-none rounded-xl p-3 text-xs text-black dark:text-white transition-all uppercase font-mono tracking-wider"
                />
              </div>

              {/* Sliders for Interactive Position, Rotation, Size on Mockup */}
              {showCustomized && (
                <div className="p-3 bg-neutral-100/45 dark:bg-neutral-900/45 border border-black/5 dark:border-white/5 rounded-xl space-y-3">
                  <div className="flex items-center justify-between text-[10px] font-mono text-gold uppercase tracking-wider font-semibold">
                    ...
                    <button 
                      ...
                      className="text-neutral-500 hover:text-black dark:text-white transition-colors text-[9px]"
                  ...
                  <div className="space-y-1.5 pt-1 pb-1 border-b border-black/5 dark:border-white/5">
                          ...
                          <button
                            ...
                            className={`text-[8.5px] font-mono px-2 py-1 rounded transition-all border ${
                              isCurrent
                                ...
                                : "bg-neutral-50 dark:bg-neutral-950 text-neutral-600 dark:text-neutral-400 border-neutral-100 dark:border-neutral-900 hover:text-black dark:text-white hover:border-neutral-200 dark:border-neutral-800"
                            }`}
                          >
                            {preset.label}
                          </button>
                  ...
                  <div className="space-y-1">
                    <div className="flex justify-between text-[9px] font-mono text-neutral-600 dark:text-neutral-400">
                    ...
                    <input 
                      ...
                      className="w-full accent-gold bg-neutral-50 dark:bg-neutral-950 h-1 rounded-lg cursor-pointer"
                    />
                  </div>
                    ...
                    <button
                       ...
                       className={`w-6 h-6 rounded-full border flex items-center justify-center transition-all ${
                         brandColor.toLowerCase() === sw.hex.toLowerCase()
                           ...
                           : "border-neutral-200 dark:border-neutral-800 hover:border-neutral-600 hover:scale-105"
                       }`}
                       style={{ backgroundColor: sw.hex }}
                    >
                      {brandColor.toLowerCase() === sw.hex.toLowerCase() && (
                        <Check size={10} className={sw.hex === "#ffffff" ? "text-black" : "text-black dark:text-white"} />
                      )}
                    </button>
                  ))}
                  {/* Custom Hex Color field */}
                  <div className="flex items-center bg-white dark:bg-black border border-black/5 dark:border-white/5 rounded-lg px-2 py-1 max-w-[100px] focus-within:border-gold transition-colors">
                    ...
                    <input
                      ...
                      className="bg-transparent text-black dark:text-white font-mono text-[10px] focus:outline-none w-full uppercase"
                    />
                  </div>
                </div>
              </div>
                      ...
                      <button
                        ...
                        className={`text-[10px] text-left p-2 rounded-xl border transition-all ${
                          isSelected
                            ...
                            : "bg-transparent text-neutral-600 dark:text-neutral-400 border-black/5 dark:border-white/5 hover:border-black/20 dark:border-white/20"
                        }`}
                      >
              ...
              {activeTechniqueDetails && (
                <motion.div
                  ...
                  className="p-3 bg-white/40 dark:bg-black/40 rounded-xl border border-black/5 dark:border-white/5 space-y-1"
                >
                  ...
                  <div className="flex gap-2 text-[8.5px] font-mono pt-1 text-neutral-500">
                    <span>Aplica-se em: <strong className="text-neutral-600 dark:text-neutral-400">{activeTechniqueDetails.materialApplied}</strong></span>
                    <span>•</span>
                    <span>Resultado: <strong className="text-neutral-600 dark:text-neutral-400">{activeTechniqueDetails.visualEffect}</strong></span>
                  </div>
                </motion.div>
              )}

              {/* B2B Volume Pricing Calculator Card */}
              <div className="p-4 bg-neutral-100/60 dark:bg-neutral-900/60 rounded-2xl border border-black/5 dark:border-white/5 space-y-4">
                <div className="flex items-center justify-between">
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between text-[10px] font-mono">
                    <span className="text-neutral-600 dark:text-neutral-400">Quantidade Desejada</span>
                    <span className="text-black dark:text-white font-bold">{b2bQuantity} unidades</span>
                  </div>
                  <input
                    type="range"
                    ...
                    className="w-full accent-gold bg-neutral-50 dark:bg-neutral-950 h-1.5 rounded-lg cursor-pointer"
                  />
                ...
                {activeTechnique === "silk" && (
                  <div className="space-y-1.5">
                    <div className="flex justify-between text-[10px] font-mono">
                      <span className="text-neutral-600 dark:text-neutral-400">Cores da Estampa (Silk Screen)</span>
                      <span className="text-black dark:text-white font-bold">{b2bColors} {b2bColors === 1 ? "cor" : "cores"}</span>
                    </div>
                        ...
                        <button
                          ...
                          className={`text-[10px] font-mono py-1 rounded-md border transition-all ${
                            b2bColors === num
                              ...
                              : "bg-transparent text-neutral-600 dark:text-neutral-400 border-black/5 dark:border-white/5 hover:border-black/10 dark:border-white/10"
                          }`}
                        >
                          {num}
                        </button>
                ...
                <div className="pt-2 border-t border-black/5 dark:border-white/5 space-y-1.5 text-[10px] font-mono">
                  ...
                  <div className="flex justify-between text-black dark:text-white font-semibold pt-1 border-t border-black/5 dark:border-white/5 text-xs">
                ...
                <div className="bg-white/40 dark:bg-black/40 border border-black/5 dark:border-white/5 rounded-xl p-2.5 flex items-center justify-between">
                  <div>
                    <span className="text-[8px] font-mono text-neutral-500 uppercase block tracking-wider">Investimento B2B Estimado</span>
                    <span className="text-sm font-sans font-bold text-black dark:text-white">R$ {totalOrderEstimate.toLocaleString("pt-BR", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                  </div>
            ...
            <div className="pt-2 space-y-3">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                <button
                  ...
                  className="bg-neutral-100 dark:bg-neutral-900 text-gold hover:bg-neutral-200 dark:bg-neutral-800 border border-gold/20 hover:border-gold/50 py-3.5 px-4 rounded-xl font-sans font-semibold text-xs uppercase tracking-wider transition-all duration-300 flex items-center justify-center gap-1.5 shadow-md active:scale-98"
                >
      ...
      <AnimatePresence>
        {isProposalModalOpen && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 bg-white/95 dark:bg-black/95 backdrop-blur-md z-50 flex flex-col items-center justify-start p-4 md:p-8 overflow-y-auto no-print"
          >
            {/* Top glassmorphic actions bar */}
            <div className="w-full max-w-4xl bg-neutral-100/80 dark:bg-neutral-900/80 backdrop-blur-md border border-black/10 dark:border-white/10 rounded-2xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4 mb-6 shadow-xl no-print">
              <div>
                <span className="text-[10px] font-mono uppercase tracking-widest text-gold block font-semibold">
                  OPUS • Curadoria Corporativa B2B
                </span>
                <h2 className="text-sm font-sans font-medium text-black dark:text-white">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="bg-neutral-200 dark:bg-neutral-800 hover:bg-neutral-700 text-neutral-700 dark:text-neutral-300 font-sans font-medium text-xs px-4 py-2.5 rounded-xl transition-all duration-300 active:scale-95 border border-black/5 dark:border-white/5"
                >
                  Fechar Dossiê
                </button>
              </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
                ...
                <div className="md:col-span-6 space-y-4">
                  <span className="text-[10px] font-mono uppercase tracking-wider text-gold bg-white dark:bg-black text-black dark:text-white px-2 py-0.5 rounded-full inline-block font-semibold">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-xs font-mono pt-2">
                    <div>
                      <span className="text-neutral-600 dark:text-neutral-400 block uppercase text-[8px]">Material Base:</span>
                      <strong className="text-neutral-800">{product.material}</strong>
                    </div>
                    <div>
                      <span className="text-neutral-600 dark:text-neutral-400 block uppercase text-[8px]">Dimensões do Produto:</span>
                      <strong className="text-neutral-800">{product.dimensions}</strong>
                    </div>
                    <div>
                      <span className="text-neutral-600 dark:text-neutral-400 block uppercase text-[8px]">Técnica de Gravação:</span>
                      <strong className="text-neutral-800">{activeTechniqueDetails?.name}</strong>
                    </div>
                    <div>
                      <span className="text-neutral-600 dark:text-neutral-400 block uppercase text-[8px]">Identidade Visual (Hex):</span>
              ...
              <div className="space-y-3">
                ...
                <table className="w-full text-left text-xs text-neutral-700 font-sans">
                  <thead>
                    <tr className="border-b border-neutral-200 text-neutral-600 dark:text-neutral-400 text-[9px] uppercase tracking-wider">
                  ...
                  <tbody>
                    <tr className="border-b border-neutral-100">
                      <td className="py-2.5 font-medium text-neutral-900">
                        {product.name} <span className="text-[10px] text-neutral-600 dark:text-neutral-400 block font-normal font-mono">Simulado com estampa personalizada</span>
                      </td>
                    ...
                    <tr className="border-b border-neutral-100">
                      <td className="py-2.5 text-neutral-600">
                        Taxa de Matriz Técnica e Clichê de Gravação <span className="text-[10px] text-neutral-600 dark:text-neutral-400 block">Custo fixo de setup industrial</span>
                      </td>
                ...
                <div className="text-[9px] text-neutral-600 dark:text-neutral-400 leading-relaxed pt-1 flex items-start gap-1">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6 border-t border-neutral-200">
                ...
                <div className="flex flex-col justify-end">
                  <div className="grid grid-cols-2 gap-4 text-center text-[10px] font-mono text-neutral-500 pt-8">
                    ...
                    <div>
                      <div className="border-b border-neutral-400 pb-2 mb-1 h-8 flex items-end justify-center">
                        <span className="text-[10px] font-mono text-neutral-600 dark:text-neutral-400 uppercase">{logoText || "DIRETOR CORPORATIVO"}</span>
                      </div>
