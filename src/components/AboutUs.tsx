...
export function AboutUs() {
  ...
  return (
    ...
    >
      ...
      <div className="relative rounded-3xl bg-neutral-950 border border-white/5 overflow-hidden p-8 sm:p-12 md:p-16 flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl">
        ...
        <div className="bg-neutral-900/60 border border-white/5 rounded-2xl p-6 space-y-4 max-w-sm w-full font-mono text-[10px] text-neutral-400 relative">
          ...
          <div className="text-center pt-2 text-[9px] text-neutral-500 uppercase tracking-widest border-t border-white/5">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
          {values.map((v, idx) => (
            <div 
              key={idx} 
              className="bg-neutral-950/60 border border-white/5 hover:border-gold/25 p-6 rounded-2xl transition-all duration-300 space-y-3 group"
            >
              <div className="w-10 h-10 rounded-xl bg-neutral-900 border border-white/10 flex items-center justify-center transition-all group-hover:scale-105">
                {v.icon}
              </div>
              <h4 className="font-sans font-medium text-sm text-white group-hover:text-gold transition-colors">
                {v.title}
              </h4>
